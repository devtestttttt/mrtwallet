...
class _PathPaymentStrictReceiveOperationViewState
  ...
  late IntegerBalance destAmount = IntegerBalance.zero(chain.network.token);
  ...
  void pickDestAssets(StellarPickedIssueAsset? destAssets) {
    ...
    destAmount = IntegerBalance.zero(destAssets.token);
    calculateMaximumAmount();
    calculateRemindAmount();
    checkIsReady();
    updateState();
  ...
  void init() {
    ...
    destAmount = IntegerBalance.zero(operation.destAsset.token);
