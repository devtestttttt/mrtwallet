...
class ImportEthereumNetwork extends StatelessWidget {
  ...
  final Web3EthereumAddNewChainForm? web3;
  const ImportEthereumNetwork.fromWeb3(this.web3, {super.key});
...
class _ImportEthereumNetwork extends StatefulWidget {
  ...
  final EthereumWeb3Form<EthereumClient?, IEthAddress?,
      Web3EthereumAddNewChain>? web3;
  @override
...
class __ImportEthereumNetworkState extends State<_ImportEthereumNetwork>
  ...
  void onChangeRpcUrl(String v) {
    if (selectedProvider != null && v.trim() != selectedProvider?.uri) {
      ...
      child: Column(
        ...
        children: [
              ...
              onActive: (context) => Column(
                      ...
                      children: [
                        ...
                        ...List.generate(state.importedProviders.length,
                          ...
                          final selected = state.selectedProvider == provider;
                          ...
                          return ContainerWithBorder(
                              ...
                              onRemoveIcon: APPAnimated(
                                  isActive: state.isWeb3 && selected,
                                  onDeactive: (context) =>
          ...
          HTTPServiceProviderFields(
              ...
              onChangeUrl: state.onChangeRpcUrl),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              FixedElevatedButton(
