...
mixin ETHTransactionFeeImpl on StateController {
  ...
  void _calculateEip(FeeHistorical fee) {
    _fees[EIP1559FeeSpeed.slow] = EthereumFee.eip1559(network,
        _gasLimit ?? EthereumUtils.baseGasLimit, fee.slow, fee.baseFee);
    _fees[EIP1559FeeSpeed.normal] = EthereumFee.eip1559(network,
        _gasLimit ?? EthereumUtils.baseGasLimit, fee.normal, fee.baseFee);
    _fees[EIP1559FeeSpeed.high] = EthereumFee.eip1559(network,
