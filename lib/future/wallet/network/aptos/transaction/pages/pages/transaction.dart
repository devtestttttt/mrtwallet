...
import 'package:on_chain_wallet/future/wallet/network/aptos/transaction/controller/controller/controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return NetworkAccountControllerView<AptosClient, IAptosAddress, AptosChain>(
        ...
        childBulder: (wallet, account, client, address, onAccountChanged) {
          return StateBuilder<AptosTransactionStateController>(
                ...
                (value) {
                  if (field.transactionType.isTokenTransfer) {
                    field.onAddSingleRecever(
                        value?.firstOrNull, (s) => context.showAlert(s));
                  } else {
