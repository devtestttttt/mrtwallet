...
import 'package:on_chain_wallet/future/wallet/network/cardano/transaction/pages/asset_info.dart';
import 'package:on_chain_wallet/future/wallet/network/cardano/transaction/pages/mint_token_view.dart';
import 'package:on_chain_wallet/future/wallet/network/cardano/transaction/pages/transaction_asset_selector.dart';
import 'package:on_chain_wallet/future/wallet/network/cardano/transaction/pages/memo_write_view.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          ContainerWithBorder(
            ...
            onRemove: () {
              context
                  .openMaxExtendSliverBottomSheet<ADAMintInfo>(
                    "mint".tr,
            ...
            onRemove: () {
              context
                  .openSliverBottomSheet<ADATransactionCertificate>(
                    "certificate".tr,
                    child:
                        CardanoTransactionCertificateView(controller.account),
                  )
              ...
              return ContainerWithBorder(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ConditionalWidget(
                        enable: (receiver.hasAssets ||
                            controller.changeAssetOutput.hasAssets),
                        onActive: (context) => ContainerWithBorder(
                                ...
                                context
                                  ...
                                  bodyBuilder: (scrollController) =>
                                      CardanoTransactionAssetSelectorView(
                                          remindAsset: controller
                                              .changeAssetOutput.asset,
                              ...
                              child: !receiver.hasAssets
                                  ...
                                  : Row(
                                      ...
                                      children: [
                                        Text(
                                          "n_asset".tr.replaceOne(receiver
                                              .asset.totalAssets
                                              .toString()),
                                          style: context
          ...
          ContainerWithBorder(
            onRemove: () {
              controller.onAddRecever(
                onSelectAddresses: ({required account, onFilterAccount}) {
                  return context.selectAccount<ADAAddress>(
                      account: account,
                      multipleSelect: true,
