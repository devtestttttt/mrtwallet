...
class _PasswordCheckerViewState extends State<PasswordCheckerView>
    with SafeState<PasswordCheckerView> {
  late final WalletAccsessType access = widget.accsess;
  late String? initialPassword = widget.password;
  ...
  void onUpdateWalletTimer(dynamic _) {
    ...
    if (time == null || time > reminingWalletTimeAlert) {
      ...
      lockTime.value = time;
      final messengerKey = ScaffoldMessenger.maybeOf(context);
      controller ??= messengerKey?.showMaterialBanner(MaterialBanner(
          actions: [
            ElevatedButton(
                onPressed: () {
                            ...
                            Row(
                              ...
                              children: [
                                ButtonProgress(
                                  ...
                                  initialStatus: state.initialPassword != null
