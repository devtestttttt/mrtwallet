    ...
    return StreamWidget(
        ...
        builder: (context, value) {
          return MaterialPageView(
            ...
            child: Scaffold(
                floatingActionButton: StreamWidget(
                        ...
                        onActive: (context) => FloatingActionButton(
                          ...
                          onPressed: status?.inProgress ?? true
                              ...
                              : () {
                                  context.openDialogPage(
                                    ...
                                    routeName: PageRouter.web3Permission,
                                    fullWidget: (context) =>
                          ...
                          child: ConditionalWidget(
                            ...
                            onDeactive: (context) => APPAnimatedSwitcher(
                              enable: status,
                              widgets: {
                                WebViewScriptStatus.active: (context) => Icon(
                                    Icons.security,
                                    color: context.colors.primary),
                                ...
                                WebViewScriptStatus.progress: (context) => Icon(
                                    Icons.security,
                                    color: context.colors.disable),
                                null: (context) => Icon(Icons.security,
                                    color: context.colors.disable)
                              },
                            ),
                          ),
