...
class BitcoinUtxoWithBalance {
  BitcoinUtxoWithBalance(
    ...
    WalletBitcoinNetwork network,
            ...
            allowNegative: false, immutable: true),
        viewAddress = utxo.ownerDetails.address
...
class BitcoinOutputWithBalance {
  ...
  BitcoinOutputWithBalance(
      ...
      : assert(() {
        ...
        tokenBalance = token == null || !token.hasAmount
            ? null
            : IntegerBalance.zero(Token(
                name: token.category, symbol: token.category, decimal: 0));
  ...
  BitcoinOutputWithBalance copyWith(
    ...
    return BitcoinOutputWithBalance._(
        ...
        balance: balance ??
            IntegerBalance.token(this.balance.balance, this.balance.token),
        address: address ?? this.address,
        ...
        tokenBalance: tokenBalance ??
            (this.tokenBalance == null
                ...
                : IntegerBalance.token(
                    this.tokenBalance!.balance, this.tokenBalance!.token)));
  }
}
