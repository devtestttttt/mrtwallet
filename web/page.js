...
(function dartProgram() {
    ...
    call$1(data) {
      ...
      if (A.JSWalletResponseType_fromName(A._asString($event.status)) === B.JSWalletResponseType_1) {
        ...
        if (A._asStringQ(walletError.message) != null)
          t1._as(init.G.console).error(A._asStringQ(walletError.message));
        t1 = _this.pageController._wait;
        if (t1 != null)
          t1.completeError$1(walletError);
        return;
      }
      t2.inited = true;
      t1._as(init.G.window).addEventListener("WALLET_ACTIVATION", A._functionToJS1(_this));
      t1 = $event.data;
  ...
  A.JSPageController.prototype = {
    postMessage$1(message) {
      return this.postMessage$body$JSPageController(message);
    },
    postMessage$body$JSPageController(message) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
    ...
    initClients$1(clientId) {
      ...
      type$.JSObject._as(init.G.window).addEventListener("ETH_" + clientId, A._functionToJS1(_this.get$_onWalletEvent()));
      t1 = _this._wait;
      if (t1 != null)
        t1.complete$0();
    }
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "async__AsyncRun__scheduleImmediateJsOverride$closure", "_AsyncRun__scheduleImmediateJsOverride", 21);
    _static_1(A, "async__AsyncRun__scheduleImmediateWithSetImmediate$closure", "_AsyncRun__scheduleImmediateWithSetImmediate", 21);
    _static_1(A, "async__AsyncRun__scheduleImmediateWithTimer$closure", "_AsyncRun__scheduleImmediateWithTimer", 21);
    _static_0(A, "async___startMicrotaskLoop$closure", "_startMicrotaskLoop", 2);
    var _;
    _instance(_ = A.ProxyMethodHandler.prototype, "get$set", 0, 4, null, ["call$4"], ["$set$4"], 43, 0, 0);
    _instance(_, "get$get", 0, 3, null, ["call$3"], ["$get$3"], 57, 0, 0);
    _instance_1_u(_ = A.JSPageController.prototype, "get$postMessage", "postMessage$1", 8);
    _instance_1_u(_, "get$_onWalletEvent", "_onWalletEvent$1", 8);
    _instance_2_u(_ = A.JSPageWalletStandardController.prototype, "get$_onEvents", "_onEvents$2", 37);
    _instance(_, "get$_connect", 0, 0, null, ["call$1", "call$0"], ["_connect$1", "_connect$0"], 58, 0, 0);
    ...
    _instance_1_u(_, "get$_signMessage", "_signMessage$1", 1);
    _instance(_, "get$_getOfflineSigner", 0, 1, null, ["call$2", "call$1"], ["_getOfflineSigner$2", "_getOfflineSigner$1"], 18, 0, 0);
    _instance(_, "get$_getOfflineSignerOnlyAmino", 0, 1, null, ["call$2", "call$1"], ["_getOfflineSignerOnlyAmino$2", "_getOfflineSignerOnlyAmino$1"], 18, 0, 0);
    _instance(_, "get$_signer", 0, 1, null, ["call$2", "call$1"], ["_signer$2", "_signer$1"], 18, 0, 0);
    _instance_1_u(_, "get$_getOfflineSignerAuto", "_getOfflineSignerAuto$1", 24);
    ...
    _instance(_, "get$_signAndSendAllTransactions", 0, 1, null, ["call$2", "call$1"], ["_signAndSendAllTransactions$2", "_signAndSendAllTransactions$1"], 49, 0, 0);
    ...
    _instance_1_u(_, "get$_signMessage", "_signMessage$1", 0);
    _instance(_ = A.SubstratePageController.prototype, "get$_knownMetadata", 0, 0, null, ["call$1", "call$0"], ["_knownMetadata$1", "_knownMetadata$0"], 50, 0, 0);
    ...
    _instance(_, "get$_connect", 0, 0, null, ["call$1", "call$0"], ["_connect$1", "_connect$0"], 17, 0, 0);
    _instance(_, "get$_connectProvider", 0, 0, null, ["call$1", "call$0"], ["_connectProvider$1", "_connectProvider$0"], 17, 0, 0);
    _instance(_, "get$update", 0, 0, null, ["call$1", "call$0"], ["update$1", "update$0"], 17, 0, 0);
    _instance_1_u(_, "get$_enable", "_enable$1", 24);
    ...
    _instance_1_u(_, "get$_sendTransaction", "_sendTransaction$1", 0);
    _instance_1_u(_, "get$_signMessage", "_signMessage$1", 0);
    _instance_1_u(_ = A.TronPageController.prototype, "get$_disabledFeature", "_disabledFeature$1", 54);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Iterable, A.CastIterator, A.Error, A.SentinelValue, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapEntryIterator, A._Record, A._UnmodifiableNativeByteBufferView, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A.TimeoutException, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.ListBase, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A.NullRejectionException, A._JSSecureRandom, A.Equatable, A.SynchronizedLock, A._Web3RequestException_Object_Equatable, A.PageRequestCompleter, A.ProxyMethodHandler, A.JSBasePageController, A.JSPageWalletStandardController, A.WalletStandardPageController, A.PageRequestController]);
    ...
    _inheritMany(A._Enum, [A.JSAptosWalletStandardUserResponseStatus, A.JSWalletMessageType, A.JSNetworkEventType, A.JSEventType, A.JSWalletResponseType, A.JSClientType, A.PageRequestType]);
