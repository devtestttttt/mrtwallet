...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    ApiProviderException_ApiProviderException$error(message) {
      return new A.ApiProviderException(message);
    },
    ...
    HTTPRequestType_fromName($name) {
      return B.JSArray_methods.firstWhere$2$orElse(B.List_7p1, new A.HTTPRequestType_fromName_closure($name), new A.HTTPRequestType_fromName_closure0());
    },
    ...
    _onActivation() {
      try {
        ...
        init.G.cryptoJsActivation = null;
      }
    },
    main(args) {
      var result, t2,
        ...
        t1 = init.G;
      if (typeof A.http___onMessage$closure() == "function")
        A.throwExpression(A.ArgumentError$(_s35_, null));
      result = function(_call, f) {
        return function(arg1) {
          return _call(f, arg1, arguments.length);
        };
      }(A._callDartFunctionFast1, A.http___onMessage$closure());
      t2 = $.$get$DART_CLOSURE_PROPERTY_NAME();
      result[t2] = A.http___onMessage$closure();
      t1.cryptoJsHandler = result;
      ...
      result[t2] = A.http___onActivation$closure();
      t1.cryptoJsActivation = result;
    },
    ...
    BigintUtils_fromBytes(bytes, byteOrder, sign) {
      ...
      if (byteOrder === B.C_Endian0) {
        ...
        bytes = A.List_List$_of(new A.ReversedListIterable(bytes, t1), t1._eval$1("ListIterable.E"));
      }
  ...
  A.BrowserClient.prototype = {
    ...
    send$body$BrowserClient(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.StreamedResponse),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, bodyBytes, t1, _0_0, contentLength, header, response, contentLengthHeader, contentLength0, headers, e, st, t2, _this, t3, t4, t5, t6, result, exception, $async$exception;
      var $async$send$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
  ...
  A.ServicesHTTPCaller.prototype = {
    ...
    makeCall$body$ServicesHTTPCaller(message, platform) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], t1, response, e, t2, exception, $async$exception;
  ...
  A.HTTPCallerResponse.prototype = {
    toJson$0() {
      return A.LinkedHashMap_LinkedHashMap$_literal(["result", this.result, "statusCode", B.JSInt_methods.toString$0(this.statusCode), "responseType", this.responseType._name], type$.String, type$.dynamic);
    }
  };
  ...
  A.Service.prototype = {
    sentResult$1(message) {
      return this.sentResult$body$Service(message);
    },
    sentResult$body$Service(message) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t1, $async$temp1;
      var $async$sentResult$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              // returning from await.
              t1 = $async$temp1.jsify($async$result.toJson$0());
              t1.toString;
              init.G.postMessage(t1);
              // implicit return
  ...
  (function installTearOffs() {
    ...
    _instance_1_i(_ = A._StreamSinkWrapper.prototype, "get$add", "add$1", 7);
    _instance(_, "get$addError", 0, 1, null, ["call$2", "call$1"], ["addError$2", "addError$1"], 25, 0, 0);
    _instance_0_u(_, "get$close", "close$0", 70);
    ...
    _instance_2_u(_, "get$_stream_splitter$_onError", "_stream_splitter$_onError$2", 5);
    _instance_0_u(_, "get$_stream_splitter$_onDone", "_stream_splitter$_onDone$0", 0);
    _static_1(A, "retry___defaultWhen$closure", "_defaultWhen", 24);
    _static_2(A, "retry___defaultWhenError$closure", "_defaultWhenError", 72);
    _static_1(A, "retry___defaultDelay$closure", "_defaultDelay", 73);
    _static_1(A, "case_insensitive_map_CaseInsensitiveMap__canonicalizer$closure", "CaseInsensitiveMap__canonicalizer", 4);
    _static_1(A, "http___onMessage$closure", "_onMessage", 54);
    _static_0(A, "http___onActivation$closure", "_onActivation", 49);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.BlockchainUtilsException, [A.CborException, A.CryptoException, A.ArgumentException]);
...
;
    ...
    B.List_7p1 = A._setArrayType(makeConstList([B.HTTPRequestType_GET_get, B.HTTPRequestType_POST_post]), A.findType("JSArray<HTTPRequestType>"));
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "MD5__t", "$get$MD5__t", () => {
      var i, i0,
        _list = J.JSArray_JSArray$markGrowable(new Array(64), type$.int);
      for (i = 0; i < 64; i = i0) {
        i0 = i + 1;
